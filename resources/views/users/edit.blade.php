...
<div class="d-flex justify-content-center align-items-center my-5">
    <div class="card shadow-lg border-0 rounded-4 w-100" style="max-width: 700px;">
        ...
        <div class="card-header text-white text-center py-4"
            ...
            <h3 class="mb-1"><i class="fas fa-user-edit"></i> Editar Usuario</h3>
            <p class="mb-0">Modifica la información del usuario seleccionado</p>
        </div>
...
<style>
    body {
        background-color: #f4f6f9; /* gris claro para que combine con la tabla */
    }
    .form-label {
        font-weight: 600;
        color: #333;
